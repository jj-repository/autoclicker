...
pyinstaller --onefile --windowed --name autoclicker --icon=icon.ico --add-data "icon.ico;." --add-data "icon.png;." --add-data "takodachi.png;." --collect-all PyQt6 autoclicker.py
